...
public class WeaponStageOne {
    ...
    public WeaponStageOne(DrawingThread drawingThread, Point topLeftPoint){
    ...
    public boolean gained(Point centerPoint){
        if(centerPoint.x>=topLeftPoint.x && centerPoint.x<=topLeftPoint.x+90*drawingThread.displayY/1080  &&  centerPoint.y>=topLeftPoint.y && centerPoint.y<=topLeftPoint.y+90*drawingThread.displayY/1080){
            this.idd=1;
            return false;
        }else{
            return true;
